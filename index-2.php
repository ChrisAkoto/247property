...
<head>
    ...
    <meta name="description" content="247Property">
    <meta name="Dicomtech" content="">
            ...
            <div id="header" class="head-tr bottom">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        ...
                        <div id="logo">
                            <a href="index.php">
                                <img src="images/logo.png" data-sticky-logo="images/logo.png" alt="">
                            </a>
                        </div>
                        <!-- Mobile Navigation -->
                                    ...
                                    <li><a href="#">Listing</a>
                                        <ul>
                                            <li><a href="#">Listing Grid</a>
                                                <ul>    
                                                    <li><a href="properties-grid-4.html">Grid View 1</a></li>
                                                </ul>
                                            </li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="rld-single-select">
                                                            <select class="select single-select mr-0">
                                                                ...
                                                                <option value="3">Asaba</option>
                                                                <option value="3">Onitsa</option>
                                                                <option value="3">Owerri</option>
                                                            </select>
                                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                        <div class="small-category-2">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Lagos</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="250">
                        <div class="small-category-2">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Abuja</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="350">
                        <div class="small-category-2">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Calabar</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="450">
                        <div class="small-category-2">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Asaba</a></h4>
                                <span>409 Properties</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                        <div class="small-category-2 mob-mt">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Onitsa</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="250">
                        <div class="small-category-2">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Owerri</a></h4>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6" data-aos="fade-up" data-aos-delay="450">
                        <div class="small-category-2 no-mb si-mt">
                            ...
                            <div class="sc-2-detail">
                                <h4 class="sc-jb-title"><a href="properties-full-grid-1.html">Lekki, Lagos</a></h4>
                                <span>254 Properties</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="single-property-1.html">
                                        <i class="fa fa-map-marker"></i><span>Megamound</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                    ...
                    <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 people rent">
                        <div class="project-single" data-aos="fade-left">
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="single-property-1.html">
                                        <i class="fa fa-map-marker"></i><span>Lekki Phase 1</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                                <ul class="homes-list clearfix pb-3">
                    ...
                    <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 people landscapes sale">
                        <div class="project-single" data-aos="fade-right">
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="single-property-1.html">
                                        <i class="fa fa-map-marker"></i><span>Maitama, Abuja</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                                <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="properties-details.html">
                                        <i class="fa fa-map-marker"></i><span>Victoria Garden City</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                                <ul class="homes-list clearfix pb-3">
                    ...
                    <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 people sale no-pb">
                        <div class="project-single no-mb" data-aos="fade-right">
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="single-property-1.html">
                                        <i class="fa fa-map-marker"></i><span>Ikoye, Lagos</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                                <ul class="homes-list clearfix pb-3">
                    ...
                    <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 it2 web rent no-pb">
                        <div class="project-single no-mb last" data-aos="fade-left">
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="single-property-1.html">
                                        <i class="fa fa-map-marker"></i><span>Beechwood Estate</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                                <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="people">
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="single-property-1.html">
                                                <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, Banana Island</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="people landscapes no-pb pbp-3">
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="single-property-1.html">
                                                <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, Ikoye</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="landscapes">
                                <div class="project-single no-mb">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="properties-details.html">
                                                <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, Parkview Estate</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="people">
                                <div class="project-single no-mb">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="single-property-1.html">
                                                <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, Lekki Phase 1</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="people landscapes no-pb pbp-3">
                                <div class="project-single no-mb last">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="single-property-1.html">
                                                <i class="fa fa-map-marker"></i><span>Lekki Gardens</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="landscapes">
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="single-property-1.html">
                                                <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, Abuja</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                            ...
                            <div class="people">
                                <div class="project-single">
                                    ...
                                    <div class="homes-content">
                                        ...
                                        <p class="homes-address mb-3">
                                            <a href="single-property-1.html">
                                                <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park South, Calabar</span>
                                            </a>
                                        </p>
                                        <!-- homes List -->
                                        <ul class="homes-list clearfix pb-3">
                                ...
                                <ul>
                                    <li>
                                        <div class="info">
                                            ...
                                            <p class="in-p">95 South Park Avenue, Lagos</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="info">
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="in-p">+234 875 369 208</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="info">
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="in-p ti">support@247property.com</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>

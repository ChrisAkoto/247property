...
// Start the session, fetch the record and insert the three values in an array
        ...
        $url = ($_SESSION['user_level'] === 2) ? '../dashboard.php' : 'ordinary_dashboard.php'; // Use a ternary operation to set the URL
	...
	echo '<p class="error" color="red">The email address and password entered do not match our records.<br>Perhaps you need to register, click the Register button on the header menu</p>';
	}

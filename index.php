    ...
    <div id="wrapper">
                ...
                <div class="container container-header">
                        ...
                        <nav id="navigation" class="style-1 head-tr">
                            <ul id="responsive">
                                <li><a href="index.php">Home <i class="fa fa-home" aria-hidden="true"></i></a></li>
                                    ...
                                    <li><a href="properties-list-2.html">Listing <i class="fa fa-list" aria-hidden="true"></i></a></li>
                                    
                                    <li>
                                        <a href="single-property-3.php">Property <i class="fa fa-home" aria-hidden="true"></i></a>
                                    </li>
                                    <li><a href="#">Pages</a>
                                        <ul>
                                            <li><a href="#">Shop</a>
                                    ...
                                    <li><a href="#">Blog <i class="fa-light fa-thought-bubble"></i></a>
                                        <ul>
                                    ...
                                    <li class="d-none d-xl-none d-block d-lg-block mt-5 pb-4 ml-5 border-bottom-0">
                                        <a href="add-property.html" class="button border btn-lg btn-block text-center">
                                            Add Listing<i class="fas fa-laptop-house ml-2"></i></a></li>
                            </ul>
                        </nav>
                        <!-- Main Navigation / End -->
                    </div>
                    ...
                    <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                        ...
                        <div class="header-widget sign-in">
                            <div class="show-reg-form modal-open"><a href="#">Log In / Register</a></div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="hero-inner">
                                ...
                                <div class="welcome-text">
                                    <h1 class="h1">Find Your Dream Property
                                    <br class="d-md-none">
                                </h1>
                                ...
                                <div class="col-12">
                                    <div class="banner-search-wrap">
                                        <ul class="nav nav-tabs rld-banner-tab">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tabs_1">Short Let</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#tabs_1">Land</a>
                                            </li>
                                        </ul>
                                        <!-- form begins -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="rld-single-select">
                                                            <select class="select single-select mr-0">
                                                                ...
                                                                <option value="2">Abia State</option>
                                                                <option value="3">Adamawa State</option>
                                                                <option value="3">Akwa Ibom State</option>
                                                                <option value="3">Anambra State</option>
                                                                <option value="3">Bauchi State</option>
                                                                ...
                                                                <option value="3">Delta State</option>
                                                                <option value="3">Ebonyi State </option>
                                                                <option value="3">Edo State</option>
                                                                <option value="3">Ekiti State</option>
                                                                <option value="1">Enugu State</option>
                                                                <option value="2">Gombe State</option>
                                                                <option value="3">Imo State</option>
                                                                <option value="3">Jigawa State</option>
                                                                <option value="3">Kaduna State</option>
                                                                <option value="3">Kano State</option>
                                                                <option value="3">Katsina State</option>
                                                                <option value="1">Kebbi State</option>
                                                                <option value="2">Kogi State</option>
                                                                <option value="3">Kwara State</option>
                                                                <option value="3">Lagos State</option>
                                                                <option value="3">Nasarawa State</option>
                                                                <option value="3">Niger State</option>
                                                                <option value="3">Ogun State</option>
                                                                <option value="3">Ondo State</option>
                                                                <option value="3">Osun State</option>
                                                                <option value="1">Oyo State</option>
                                                                <option value="2">Plateau State</option>
                                                                <option value="3">Rivers State</option>
                                                                <option value="3">Sokoto State</option>
                                                                <option value="3">Taraba State</option>
                                                                <option value="3">Yobe State</option>
                                                                <option value="3">Zamfara State</option>
                                                            </select>
                                                        </div>
                                                        <div class="dropdown-filter d-none d-none d-lg-none d-xl-block"><span>Advanced Search <i class="fa fa-search" aria-hidden="true"></i></span></div>
                            ...
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    <div class="listing-badges">
                                        <span class="featured">N 230M</span>
                                        <span>For Sale</span>
                                    </div>
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>VGC, Lagos</i></span>
                    ...
                    <div class="item col-lg-4 col-md-6 col-xs-12 people rent">
                        <div class="project-single" data-aos="zoom-in" data-aos-delay="250">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    <div class="listing-badges">
                                        <span class="featured">N 65M</span>
                                        <span>For Sale</span>
                                    </div>
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Ikota, Lagos</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                        ...
                        <div class="project-single" data-aos="zoom-in" data-aos-delay="350">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Lekki Phase 1</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                        ...
                        <div class="project-single no-mb" data-aos="zoom-in" data-aos-delay="150">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Maitama, Abuja</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                        ...
                        <div class="project-single no-mb" data-aos="zoom-in" data-aos-delay="250">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Megamound, Lagos</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                    ...
                    <div class="item col-lg-4 col-md-6 it2 col-xs-12 web rent no-pb">
                        <div class="project-single no-mb last" data-aos="zoom-in" data-aos-delay="350">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    <div class="listing-badges">
                                        <span class="featured">N 650M</span>
                                        <span>For Sale</span>
                                    </div>
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Beechwood Est., Lagos</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                        ...
                        <div class="project-single" data-aos="zoom-in" data-aos-delay="250">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Ikeja GRA</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                        ...
                        <div class="project-single" data-aos="zoom-in" data-aos-delay="350">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Ajaho Est., Lagos</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                    ...
                    <div class="item col-lg-4 col-md-6 col-xs-12 people landscapes rent no-pb">
                        <div class="project-single no-mb" data-aos="zoom-in" data-aos-delay="150">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    <div class="listing-badges">
                                        <span class="featured">N 650N</span>
                                        <span class="rent">For Rent</span>
                                    </div>
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Chevy View Est., Lagos</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                        ...
                        <div class="project-single no-mb" data-aos="zoom-in" data-aos-delay="250">
                            <div class="listing-item compact">
                                <a href="single-property-1.html" class="listing-img-container">
                                    ...
                                    <div class="listing-img-content">
                                        <span class="listing-compact-title">House Luxury <i>Magodo, Lagos</i></span>
                                        <ul class="listing-hidden-content blue">
                                            <li>Area <span>720 sq ft</span></li>
                                            <li>Rooms <span>6</span></li>
                                            <li>Beds <span>2</span></li>
                            ...
                            <div class="project-inner project-head">
                                <div class="homes">
                                    ...
                                    <a href="single-property-1.html" class="homes-img">
                                        ...
                                        <div class="homes-price">N900K/mo</div>
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="single-property-1.html">
                                        <i class="fa fa-map-marker"></i><span>Chevy View Estate</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                            ...
                            <div class="project-inner project-head">
                                <div class="homes">
                                    ...
                                    <a href="single-property-1.html" class="homes-img">
                                        ...
                                        <div class="homes-price">N300K/mo</div>
                            ...
                            <div class="homes-content">
                                ...
                                <p class="homes-address mb-3">
                                    <a href="properties-details.html">
                                        <i class="fa fa-map-marker"></i><span>Mountain Top, Abeokuta</span>
                                    </a>
                                </p>
                                <!-- homes List -->
                                <ul class="homes-list clearfix pb-0">
        ...
        <footer class="first-footer">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="netabout">
                                <a href="index.php" id="logo">
                                    <img src="images/logo.png" alt="247property">
                                </a>
                                ...
                                <ul>
                                    <li>
                                        <div class="info">
                                            ...
                                            <p class="in-p">Ikota Complex</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="info">
                                            <i class="fa fa-phone" aria-hidden="true"></i>
                                            <p class="in-p">+234 806 541 0991</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="info">
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="in-p ti">support@247property.com.ng</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="twitter-widget contuct">
                                    <div class="twitter-area">
                                        <div class="single-item">
                                            ...
                                            <div class="text">
                                                <h5><a href="#">@247property</a> all share them with me baby said inspet.</h5>
            ...
            <div class="second-footer">
                <div class="container">
                    <p>Developed by <a href="http://dicomtech.tech">DICOMTECH</a></p>
                    <ul class="netsocials">
        ...
        <div class="login-and-register-form modal">
            ...
            <div class="main-register-holder">
                <div class="main-register fl-wrap">
                    ...
                    <h3>Welcome to <span>247<strong>Property</strong></span></h3>
                    <div id="tabs-container">
                        <ul class="tabs-menu">
                            <li class="current"><a href="#tab-1">Login</a></li>
                            <li><a href="#tab-2">Not yet registered? Register</a></li>
                        </ul>
                        <div class="tab">
                            <div id="tab-1" class="tab-contents">
                                <div class="custom-form">
                                    <form method="post" name="registerform" action="control/login_processor.php">
                                        <label>Username or Email Address * </label>
                                        <input name="email" type="text" onClick="this.select()" required>
                                        <label>Password * </label>
                                        <input name="psword" type="password" onClick="this.select()"  required>
                            ...
                            <div class="tab">
                                <div id="tab-2" class="tab-contents">
                                    <div class="custom-form">
                                        <form method="post" name="registerform2" action="control/register_processor.php" 
                                        class="main-register-form" id="main-register-form2">
                                            <label>First Name * </label>
                                            <input name="fname" type="text" onClick="this.select()"  required>
                                            <label>Last Name *</label>
                                            <input name="lname" type="text" onClick="this.select()"  required>
                                            <label>Company Name *</label>
                                            <input name="cname" type="text" onClick="this.select()"  required>
                                            ...
                                            <input name="psword2" type="password" onClick="this.select()"  required>
